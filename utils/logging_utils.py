...
class Formatter(logging.Formatter):
    ...
    COMPONENT_COLORS = {
        ...
        'utils': Colors.NEON_LIME,
        'model_factory': Colors.DARK_BLUE,
        'dataset_manager': Colors.DARK_CYAN,
        'check_params': Colors.DARK_MAGENTA,
        'model_registry': Colors.DARK_GREEN,
        'logging': Colors.DARK_ORANGE,
    }
